...
public final class Cookie2 {
    ...
    private Cookie2(String name, String value, long expiresAt, String domain, String path,
    ...
    Cookie2(Cookie2.Builder builder) {
     ...
     */
    public static Cookie2 parse(HttpUrl url, String setCookie) {
        return parse(System.currentTimeMillis(), url, setCookie);
    }

    static Cookie2 parse(long currentTimeMillis, HttpUrl url, String setCookie) {
        int pos = 0;
...
//            return null; // No domain match? This is either incompetence or malice!
        ...
        return new Cookie2(cookieName, cookieValue, expiresAt, domain, path, secureOnly, httpOnly,
                hostOnly, persistent);
    }
...
//        return canonicalDomain;
    ...
    public static List<Cookie2> parseAll(HttpUrl url, Headers headers) {
        List<String> cookieStrings = headers.values("Set-Cookie");
        List<Cookie2> cookies = null;

        for (int i = 0, size = cookieStrings.size(); i < size; i++) {
            Cookie2 cookie = Cookie2.parse(url, cookieStrings.get(i));
    ...
    public static final class Builder {
        ...
        public Cookie2.Builder name(String name) {
        ...
        public Cookie2.Builder value(String value) {
        ...
        public Cookie2.Builder expiresAt(long expiresAt) {
         ...
         * subdomains.
         */
        public Cookie2.Builder domain(String domain) {
         ...
         * its subdomains.
         */
        public Cookie2.Builder hostOnlyDomain(String domain) {
            return domain(domain, true);
        }

        private Cookie2.Builder domain(String domain, boolean hostOnly) {
        ...
        public Cookie2.Builder path(String path) {
            if (!path.startsWith("/")) throw new IllegalArgumentException("path must start with '/'");
            this.path = path;
            return this;
        }

        public Cookie2.Builder secure() {
            this.secure = true;
            return this;
        }

        public Cookie2.Builder httpOnly() {
            this.httpOnly = true;
            return this;
        }

        public Cookie2 build() {
            return new Cookie2(this);
        }
    }
    ...
    @Override public boolean equals(Object other) {
        if (!(other instanceof Cookie2)) return false;
        Cookie2 that = (Cookie2) other;
